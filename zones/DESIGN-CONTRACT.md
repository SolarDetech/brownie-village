...
- Agent, service and resource zones: keep all art inside **x −190..190, y −150..140**. The castle may use x −252..252, y −212..200 (entrance at (0, 200)). The Grand Library (plot 520 × 350) may use x −250..250, y −190..140 (entrance at (0, 140)).
- The world draws the grass plot under the zone and a dirt path that arrives at the **bottom centre (0, 140)**. Keep a walkable entrance there.
